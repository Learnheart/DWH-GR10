...
with DAG('ChinookWarehouse', schedule_interval=timedelta(days=1), default_args=default_args) as dag:
...
[check_dataset_artist, check_dataset_album, check_dataset_playlist, check_dataset_mediaType, check_dataset_genre, check_dataset_track, check_dataset_playlistTrack, check_dataset_employee, check_dataset_customer, check_dataset_invoice, check_dataset_invoiceLine] >> create_D_Table
